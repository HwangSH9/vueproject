<template>
    <div class="bgbg">
        ...
        <div class="grayBox">
            ...
            <router-link :to="{ name: 'FoodNoticeCat', params: { id: product.id } }"
...
import cartItems from '@/assets/snackside.js';
...
export default {
    ...
    created() {
        ...
        this.product = cartItems.find((item) => item.id === parseInt(productId));
        if (!this.product) {
